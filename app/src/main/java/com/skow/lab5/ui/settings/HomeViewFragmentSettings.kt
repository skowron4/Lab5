...
class HomeViewFragmentSettings : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.radioButtonImage1.isEnabled = false
        binding.radioButtonImage2.isEnabled = false
        binding.radioButtonImage3.isEnabled = false
        binding.radioButtonImage4.isEnabled = false
